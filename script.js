...
const translations = {
    es: {
        ...
        'hero-stats-ai': 'Proyectos con IA',
        'hero-stats-efficiency': 'Mejora en Eficiencia',
        ...
        'about-goals-short-text': 'Consolidar experiencia en proyectos AI-driven y obtener certificaciones AWS y GCP',
        'about-goals-medium': 'Mediano Plazo:',
        'about-goals-medium-text': 'Liderar proyectos de transformación digital con arquitecturas cloud-native',
        'about-goals-long': 'Largo Plazo:',
        'about-goals-long-text': 'Especialista en Cloud Architecture & AI Engineering',
        'about-why-title': '💼 Por Qué Trabajar Conmigo',
        'about-why-leadership': 'Maestría Completada:',
        'about-why-leadership-text': 'MISO finalizada con especialización en Cloud, DevOps, IA y Arquitecturas',
        'about-why-architecture': 'Resultados Medibles:',
        'about-why-architecture-text': 'Mejoras comprobadas del 25-70% en eficiencia operativa en proyectos reales',
        'about-why-agile': 'Arquitectura AI-Driven:',
        'about-why-agile-text': 'Experiencia práctica con RAG, LangChain, N8N y microservicios inteligentes',
        'about-why-digital': 'Expertise Cloud:',
        'about-why-digital-text': 'Experiencia hands-on en GCP (Cloud Run, Firestore, Cloud Build) y AWS',
        'about-why-innovation': 'Liderazgo Técnico:',
        'about-why-innovation-text': '10+ años liderando equipos multidisciplinarios y proyectos complejos',
        ...
        'about-education-masters-period': '2023 - 2025 | COMPLETADA',
    ...
    en: {
        ...
        'hero-stats-ai': 'AI Projects',
        'hero-stats-efficiency': 'Efficiency Gain',
        ...
        'about-goals-short-text': 'Consolidate AI-driven projects and obtain AWS and GCP certifications',
        'about-goals-medium': 'Medium Term:',
        'about-goals-medium-text': 'Lead digital transformation projects with cloud-native architectures',
        'about-goals-long': 'Long Term:',
        'about-goals-long-text': 'Cloud Architecture & AI Engineering Specialist',
        'about-why-title': '💼 Why Work With Me',
        'about-why-leadership': 'Masters Completed:',
        'about-why-leadership-text': 'MISO completed with specialization in Cloud, DevOps, AI and Architectures',
        'about-why-architecture': 'Measurable Results:',
        'about-why-architecture-text': 'Proven improvements of 25-70% in operational efficiency in real projects',
        'about-why-agile': 'AI-Driven Architecture:',
        'about-why-agile-text': 'Hands-on experience with RAG, LangChain, N8N and intelligent microservices',
        'about-why-digital': 'Cloud Expertise:',
        'about-why-digital-text': 'Hands-on experience in GCP (Cloud Run, Firestore, Cloud Build) and AWS',
        'about-why-innovation': 'Technical Leadership:',
        'about-why-innovation-text': '10+ years leading multidisciplinary teams and complex projects',
        'about-education-title': '📚 Education',
        'about-education-masters': 'Masters in Software Engineering (MISO) ✓',
        'about-education-masters-uni': 'Universidad de los Andes',
        'about-education-masters-period': '2023 - 2025 | COMPLETED',
