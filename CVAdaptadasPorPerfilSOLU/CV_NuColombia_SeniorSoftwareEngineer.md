...
Ingeniero Electrónico con más de 10 años de experiencia en desarrollo de software y arquitectura de sistemas distribuidos. Especializado en el diseño e implementación de microservicios, sistemas escalables en la nube y metodologías ágiles. Experiencia comprobada liderando equipos de desarrollo, implementando CI/CD y trabajando con tecnologías cloud (AWS/GCP). Capacidad demostrada para trabajar con sistemas de gran escala y colaborar efectivamente con equipos multidisciplinarios.
...
- Diseñé e implementé 15+ proyectos de automatización para grandes superficies comerciales, call centers y edificios corporativos
