# JULIO CESAR FORERO
## INGENIERO DE INTELIGENCIA ARTIFICIAL | AI DEVELOPER & MACHINE LEARNING ENGINEER
...
Ingeniero Electrónico con más de 10 años de experiencia en desarrollo de software y especialización en Inteligencia Artificial. Especializado en el diseño, implementación y optimización de modelos de IA generativa, NLP y soluciones cognitivas empresariales. Experiencia comprobada en proyectos de RAG, modelos open-weight (LLaMA, Mistral, Falcon) y frameworks como PyTorch y Hugging Face. Capacidad demostrada para desarrollar soluciones de IA escalables y colaborar en equipos multidisciplinarios.
...
**Sistemas de RAG y Soluciones Cognitivas** | 2023 - Presente
- **Desarrollé soluciones de Retrieval-Augmented Generation para procesamiento de documentos empresariales**
- **Implementé sistemas de búsqueda semántica y generación de respuestas inteligentes**
